from batch_entmax_gaussian_kernels import BiweightGaussian1DKernel
import torch
...
class ContinuousBiweightFunction(torch.autograd.Function):
    @classmethod
    ...
    def forward(cls, ctx, theta, psi):
        ...
        mu = theta[:, 0] * sigma ** 2
        kernel = BiweightGaussian1DKernel(mu, sigma**2)
...
class ContinuousBiweight(nn.Module):
    ...
    def forward(self, theta):
        return ContinuousBiweightFunction.apply(theta, self.psi)
